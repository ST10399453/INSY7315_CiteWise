import { validationResult } from "express-validator"; // (express-validator, 2019)

/**
 * Validates Express request input and halts early on validation errors.
 * Returns HTTP 400 if validation fails (express-validator, 2019; Manico & Detlefsen, 2015)
 */
...
/**
 * Checks whether the authenticated user has admin-level privileges.
 ...
 * Owners, consultants, or admins are granted access (Manico & Detlefsen, 2015; Firebase, 2019b)
 */
